...
HD_PWD='C:/FPGA_HARMAN/ip_repo/frame_buffer/frame_buffer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xy_frame_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xy_frame_buffer.tcl
