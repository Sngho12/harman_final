...
HD_PWD='C:/FPGA_HARMAN/ip_repo/ov7670_driver/ov7670_driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7670_VGA_Driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OV7670_VGA_Driver.tcl -notrace
