...
HD_PWD='C:/FPGA_HARMAN/ip_repo/ov7670_driver/ov7670_driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7670_VGA_Driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV7670_VGA_Driver.tcl
