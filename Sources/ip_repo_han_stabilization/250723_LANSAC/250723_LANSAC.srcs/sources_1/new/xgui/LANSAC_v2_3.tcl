...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ADJUST_AFFINE_ROTATE_THRES" -parent ${ADJUST_AFFINE_LIMITATION}
...
proc update_PARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES { PARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES } {
	# Procedure called to update ADJUST_AFFINE_ROTATE_THRES when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES { PARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES } {
	# Procedure called to validate ADJUST_AFFINE_ROTATE_THRES
	return true
}
...
proc update_MODELPARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES { MODELPARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES PARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES}] ${MODELPARAM_VALUE.ADJUST_AFFINE_ROTATE_THRES}
}
