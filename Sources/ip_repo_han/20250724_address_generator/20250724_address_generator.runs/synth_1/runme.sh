...
HD_PWD='C:/FPGA_HARMAN/ip_repo/20250724_address_generator/20250724_address_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log affine_address_modifier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source affine_address_modifier.tcl
