...
module top_tb;
    ...
    logic [X_WIDTH:0] x_coor;
    logic [Y_WIDTH:0] y_coor;

    // Outputs
    logic pair_valid;
    logic pair_done;
    logic [X_WIDTH:0] current_feature_X;
    logic [Y_WIDTH:0] current_feature_Y;
    logic [X_WIDTH:0] prev_feature_X;
    logic [Y_WIDTH:0] prev_feature_Y;
    ...
    initial begin
        ...
        // Simulation run
            repeat (H_RES*V_RES) begin
                ...
                // Randomly assert isCorner
                isCorner = $urandom_range(0,1);
            end
        end
        #100;
